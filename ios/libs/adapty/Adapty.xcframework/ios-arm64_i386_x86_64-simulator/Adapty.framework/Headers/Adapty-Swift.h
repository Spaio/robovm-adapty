...
typedef SWIFT_ENUM(NSInteger, AdaptyErrorCode, open) {
...
typedef SWIFT_ENUM(NSInteger, AdaptyLogLevel, open) {
...
typedef SWIFT_ENUM(NSInteger, DataState, open) {
  DataStateCached = 0,
  DataStateSynced = 1,
};
...
typedef SWIFT_ENUM(NSUInteger, PaymentMode, open) {
...
typedef SWIFT_ENUM(NSUInteger, PeriodUnit, open) {
  PeriodUnitDay = 0,
  PeriodUnitWeek = 1,
  PeriodUnitMonth = 2,
  PeriodUnitYear = 3,
